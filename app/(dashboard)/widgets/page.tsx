...
// import StatsCardThree from '@/app/(dashboard)/(homes)/cryptocurrency/components/stats-card'; // Folder doesn't exist
...
// import StaticCard from "@/app/(dashboard)/(homes)/investment/components/static-card"; // Folder doesn't exist
